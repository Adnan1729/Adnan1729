...
Doctoral Researcher at the University of Edinburgh, funded by the UK Ministry of Defence.
...
Bayesian graphical modelling for real-time evidence fusion across distributed autonomous platforms.

Swarm intelligence at the tactical edge: intermittent connectivity, adversarial perturbation, partial observability.

Latent causal states, never observed, reconstructed from noise.
...
Senior Modelling Engineer at Network Rail, leading ML for infrastructure fault prediction across the UK rail network. Collaborated with Deloitte, Cognizant, Capgemini, Faculty AI, and Arthur D. Little.
